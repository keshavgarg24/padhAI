  ...
  return (
    <section className="bg-gradient-to-br from-blue-600 via-blue-700 to-indigo-900 min-h-screen flex items-center justify-center">
      <div className="lg:grid lg:min-h-screen lg:grid-cols-12 shadow-xl rounded-lg overflow-hidden">
        ...
        <main className="flex items-center justify-center bg-white px-8 py-8 sm:px-12 lg:col-span-5 lg:px-16 lg:py-12 xl:col-span-6">
        ...
        <section className="relative flex flex-col justify-center bg-blue-600 bg-opacity-90 lg:col-span-7 lg:h-full xl:col-span-6 p-10 lg:p-12">
